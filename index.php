...
//////////////////////////////////////////////////////////////////////////////////////////////////////
                                      ///文章标题列表查询
/////////////////////////////////////////////////////////////////////////////////////////////////////
$sql_list="select `id`,`title` from `".$tb_prefix."newscontent`  order by id DESC";//查询顶级分类
...
$sql_content="select * from `".$tb_prefix."newscontent`  order by id DESC limit 6" ;//查询顶级分类
